...
public class MongoPlusServiceImpl<T> implements IMongoPlusService<T> {
    ...
    public T getById(String id) {
        ...
        return mongoTemplate.findOne(new Query(criteria), Objects.requireNonNull(getMongoBean()));
    }
    ...
    public List<T> getByCondition(T t) {
        ...
        return mongoTemplate.find(new Query(criteria),Objects.requireNonNull(getMongoBean()));
    }
    ...
    public long updateById(T t) {
        ...
        try {
            ...
            return mongoTemplate.updateMulti(new Query(criteria),update,Objects.requireNonNull(getMongoBean())).getModifiedCount();
    ...
    public List<T> getByQuery(Query query) {
        ...
        return mongoTemplate.find(query,Objects.requireNonNull(getMongoBean()));
    }

    @Override
    public long updateByQuery(Query query, Update update) {
        assert query!=null&&update!=null:"查询条件和更新数据不允许为空";
        return mongoTemplate.updateMulti(query,update,Objects.requireNonNull(getMongoBean())).getModifiedCount();
    }

    @Override
    public long deleteByQuery(Query query) {
        assert query!=null:"查询条件不允许为空";
        return mongoTemplate.remove(query,Objects.requireNonNull(getMongoBean())).getDeletedCount();
    }
